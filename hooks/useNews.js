...
export const news = [
  {
    id: "15",
    title: "Resultados da quarta etapa do JGTC 90s",
    data: "26/02/2023",
    texto:
      "Estão disponíveis os resultados da etapa de Dragon Trail do JGTC 90s. Após uma etapa sem incidentes, Dudu Fiel mantém a liderança do campeonato, mas a diferença para o segundo colocado permance a mesma. Confira o ranking geral:",
    image: "",
    url: "/campeonatos",
  },
  {
    ...
    },
    {
      ...
      data: "20/02/2023",
      texto:
        "Está disponível o resultado da etapa de Suzuka do JGTC 90s. Dudu Fiel assume a liderança do Ranking Geral, e deixa o campeonato ainda mais acirrado! Confira a pontuação geral:",
      image: "",
      url: "/campeonatos",
    },
    {
